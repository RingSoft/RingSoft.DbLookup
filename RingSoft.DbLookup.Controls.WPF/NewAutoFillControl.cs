...
namespace RingSoft.DbLookup.Controls.WPF
{
    ...
    ///
    /// </summary>
    public class NewAutoFillControl : Control
    {
        static NewAutoFillControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(NewAutoFillControl), new FrameworkPropertyMetadata(typeof(NewAutoFillControl)));
        }
    }
}
